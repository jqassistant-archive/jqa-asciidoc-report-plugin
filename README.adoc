...
Therefore a report property `render=component-diagram` must be set and the result of a rule simply needs to return all required nodes and their relationships:
