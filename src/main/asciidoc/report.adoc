...
=== Asciidoc Files in Plugins

Asciidoc files may be distributed as part of plugins to allow sharing rules and reports.
...
META-INF/
  ...
  |-jqassistant-rules/
    |-my-rules/
      ...
      |-included-file.adoc
----
* Each file containing rules must be registered in the plugin descriptor
+
[source,xml]
...
<jqassistant-plugin>
    <rules>
        <resource>my-rules/index.adoc</resource>
        <resource>my-rules/included-file.adoc</resource>
    </rules>
</jqassistant-plugin>
----
